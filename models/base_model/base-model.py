...
class InferSent(nn.Module):
    def __init__(self, enc_hidden_dim, cls_hidden_dim, train_loader_1, train_loader_2, num_epochs=2):
    ...
    def train_model(self, optimizer, scheduler):
        ...
        for epoch in range(self.num_epochs):
            ...
            for step, (batch1, batch2) in enumerate(zip(self.train_loader_1, self.train_loader_2)):
                ...
                optimizer.zero_grad()
                outputs = self((b_input_ids, b_input_ids2))
    ...
    def evaluate_model(self):
        ...
        for batch1, batch2 in zip(self.test_loader_1, self.test_loader_2):
...
model = InferSent(1028, 512, train_loader_1, train_loader_2, test_loader_1, test_loader_2).to(device)
